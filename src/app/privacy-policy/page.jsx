const PrivacyPolicy = () => {
  return (
    <div className="p-[2rem]">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to The Wellness Point.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to The Wellness Point, accessible
            from
            <a
              href="https://thewellnesspoint.club"
              rel="external nofollow noopener"
              target="_blank"
            >
              thewellnesspoint.club
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@thewellnesspoint.club</li>
      </ul>
    </div>
  );
};
