...
const page = () => {
  return (
    <div className="p-[2rem]">
      ...
      <p>Welcome to The Wellness Point!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of The Wellness Point&apos;s Website, located at thewellnesspoint.club.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use The Wellness Point if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing The Wellness Point, you agreed to use
        cookies in agreement with the The Wellness Point&apos;s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, The Wellness Point and/or its licensors own the
        intellectual property rights for all material on The Wellness Point. All
        intellectual property rights are reserved. You may access this from The Wellness Point for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from The Wellness Point</li>
        <li>Sell, rent or sub-license material from The Wellness Point</li>
        <li>Reproduce, duplicate or copy material from The Wellness Point</li>
        <li>Redistribute content from The Wellness Point</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. The Wellness Point does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of The Wellness Point,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, The Wellness Point shall not be liable for
      ...
      <p>
        The Wellness Point reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant The Wellness Point a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of The Wellness Point; and (d) the link is
      ...
      <p>
        ...
        e-mail to The Wellness Point. Please include your name, your organization name,
      ...
      <p>
        No use of The Wellness Point&apos;s logo or other artwork will be allowed for linking
